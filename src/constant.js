...
const tarjetas = [
    {label: 'Educación Primaria Nivelatoria', id : 1 , grados :'Grados: 1° a 5°', img:'./src/assets/img/primaria.webp' ,contenido: 'Dirigido a: Niños y niñas que no han iniciado o han interrumpido su educación básica primaria ', objetivo : 'Objetivo: Brindar las herramientas fundamentales en lectoescritura, matemáticas, ciencias y desarrollo personal, permitiendo el ingreso a la educación media Modalidad: Nivelación flexible con acompañamiento docente personalizado.'},
    {label: ' Educación Media Nivelatoria', id : 2,grados :'Grados: 6° a 9°', img:'./src/assets/img/secundaria.webp'  ,contenido: 'Dirigido a: Adolescentes y jóvenes que desean continuar sus estudios de básica secundaria después de un periodo de interrupción', objetivo : ' Objetivo: Fortalecer competencias académicas clave, pensamiento crítico y habilidades sociales para la vida Metodología: Aprendizaje por competencias, con énfasis en valores y trabajo colaborativo.'},
    {label: 'Educación Superior Secundaria Nivelatoria', id : 3 ,grados :'Grados: 10° y 11°', img:'./src/assets/img/media.webp',contenido: 'Dirigido a: Jóvenes que buscan culminar su bachillerato de manera flexible',objetivo : ' Objetivo: Preparar a los estudiantes para obtener el título de Bachiller Académico, y orientarlos en la elección de su proyecto de vida: educación superior, técnica o inserción laboral. Enfoque: Formación integral, orientación vocacional y preparación para pruebas Saber 11.'}
